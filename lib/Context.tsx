...
const demoData: LinkProps = {
  ...
  fb: 'https://www.facebook.com/sseworld',
  tw: 'https://twitter.com/sseworld',
  ig: 'https://www.instagram.com/sseworld/',
  tg: 'https://t.me/@sseworldbot',
  gt: 'https://github.com/sseworld',
  lk: 'https://linkedin.com/in/sseworld',
  em: 'sseworld4@gmail.com',
  wh: '+916666666666',
  yt: 'https://youtube.com/@sseworld',
  bg: '#4F4F4F',
  ls: [
    {
      id: 1,
